...
def before_anonymous() -> dict:
  with open("backend/template/payloads/anonymous_befeore_entering_msg.json", "r") as f:
    tmpl = json.load(f)
  return tmpl

def do_anonymous(user_id: str) -> dict:
  with open("backend/template/payloads/anonymous_hide.json", "r") as f:
    tmpl = json.load(f)
...
def ask_for_questionnaire() -> dict:
  with open("backend/template/payloads/anoymous_post_response.json", "r") as f:
    tmpl = json.load(f)
  return tmpl
...
def anonymous_form(user_id: str, display: str) -> dict:
  ...
  with open("backend/template/payloads/%s"%file_name, "r") as f:
    tmpl = json.load(f)
  tmpl_set_params = set_params_for_anonymous_post(tmpl, user_id)
  return tmpl_set_params

def do_anonymous_questionnaire():
  with open("backend/template/payloads/anonymous_questionnaire.json", "r") as f:
    tmpl = json.load(f)
  return tmpl
